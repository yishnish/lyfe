describe('Visualizers', function () {
        ...
        describe("from a data array", function () {
            describe("validations", function () {
                it('should fail when there is no color mapping', function () {
                    expect(function () {
                        new Visualizer(new World([[new VegetarianCreature('vole'), new VegetarianCreature('bird')]]), null);
            ...
            it('should create a DOM table with the same number of rows and columns as the data', function () {
                var viz = new Visualizer(new World([[new VegetarianCreature("vole")]]), ColorMapping);
            ...
            describe('color mapping', function () {
                it('should have table elements colored according to their matching type', function () {
                    var viz = new Visualizer(new World([[new VegetarianCreature("vole"), new VegetarianCreature("bird")]]), ColorMapping);
    ...
    describe("updating a display", function () {
        ...
        beforeEach(function () {
            vole = new VegetarianCreature("vole");
            bird = new VegetarianCreature('bird');
